/* Mapa del Morfi: guarda la app y los datos para usarla sin internet. Versión ccf98a7e80 */
const V='morfi-ccf98a7e80', CORE=["./", "index.html", "manifest.webmanifest", "icon-192.png", "icon-512.png", "icon-maskable-512.png", "apple-touch-icon.png", "favicon.png", "geo.js", "calles.js", "landmarks.js", "places.js"];
