/* Mapa del Morfi: guarda la app y los datos para usarla sin internet. Versión c22f4de6df */
const V='morfi-c22f4de6df', CORE=["./", "index.html", "manifest.webmanifest", "icon-192.png", "icon-512.png", "icon-maskable-512.png", "apple-touch-icon.png", "favicon.png", "geo.js", "calles.js", "landmarks.js", "places.js"];
